<div class="row row-cols-1 row-cols-md-2 d-none" id="formkredit">
    <div class="col">
        ...
        <label class="transition" for="nama">kredit</label>
        </div>
    </div>
    <div class="col">
        <div class="form-floating mb-3">
        ...
        <label class="transition" for="ktp_pembeli">kredit</label>
        </div>
    </div>
    <div class="col">
        <div class="form-floating mb-3">
        ...
        <label class="transition" for="telp_pembeli">Tanggal Pembayaran</label>
        </div>
    </div>
</div>